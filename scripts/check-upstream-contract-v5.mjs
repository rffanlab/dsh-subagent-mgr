...
// final normalized ToolExecutionResult. This is the stable attribution point
// for one unique managed toolName.
...
// The Web stats panel deliberately reuses the existing command Remote rather
// than inventing a second telemetry RPC. uiSession supplies the current
// sessionId used by that endpoint.
...
console.log('DeepSeek Harness control-plane and observability contracts still match dsh-subagent-mgr v0.5.')
